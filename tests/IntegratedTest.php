...
class IntegratedTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->integrated = new Integrated($l1, $this->l2, 1, 1);
    }

    public function testCreatedTime()
    {
        $this->assertInternalType('int', $this->integrated->getCreatedTime());
        $this->assertGreaterThan(0, $this->integrated->getCreatedTime());
    }
    ...
    public function testSet()
    {
        ...
        $integrated = new Integrated($l1, $this->l2, 1, 1);
